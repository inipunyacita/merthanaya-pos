...
import { DollarSign, ShoppingCart, TrendingUp, Package, RefreshCw, ChevronLeft, ChevronRight } from 'lucide-react';
import { useState, useEffect } from 'react';
import { POSLayout } from '@/components/pos';
import { SalesSummary, TopProduct, CategorySales, DailySales, HourlyDistribution } from '@/types';
...
export default function AnalyticsPage() {
    ...
    return (
        <POSLayout title="Analytics" description="Sales and performance insights" showCart={false}>
            <div className="text-black flex flex-col items-start h-64 px-4">
                                            ...
                                            return (
                                                <div key={cat.category} className="flex items-center justify-between text-sm py-2 border-b last:border-0">
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        <span className="text-gray-500 ml-2">({cat.order_count} orders)</span>
                                                    </div>
                                                </div>
                                            );
                                        })}
